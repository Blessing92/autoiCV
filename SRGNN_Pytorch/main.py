...
logger = logging.getLogger('SRGNN_AutoML')
...
def main(opt):
    ...
    for epoch in range(opt['epoch']):
        print('-------------------------------------------------------')
        print('Epoch: ', epoch)
        hit, mrr, total_loss = train_test(model, train_data, test_data, opt['K'])
        #flag = 0
