...
logger = logging.getLogger('NextitNet_AutoML')
...
def get_params():
    ...
    parser.add_argument('--datapath', type=str, default='~/Documents/Datasets/RecSys/4-3(16 portion).csv', help='data path')
...
def main(args):    
    ...
    for i,row in exps.iterrows():
        ...
        vdl = data_loader_recsys.Data_Loader(args, testFlag = True, itemsIDs = dl.itemsIDs, max_doc = dl.max_document_length, vocab_proc = dl.vocab_processor)
        valid_set = vdl.item
        ...
        model_para = {
            ...
            'batch_size':int(args['batch_size']),#YOU should tune this hyper-parameter
            'epochs':args['epochs'],# if your dataset is small, suggest adding regularization to prevent overfitting
...
if __name__ == '__main__': 
    try:
        ...
        tuner_params['epochs'] = tuner_params['TRIAL_BUDGET'] * 10
